  ...
  function(oj, ko) { // this callback gets executed when all required modules are loaded
    ...
    function viewModel() {
      ...
      self.availableAppEnvironments = ko.observableArray([
        new AppEnvironment("ERP Cloud Purchasing - eqir", "https://fa-eqir-dev14-saasfademo1.ds-fa.oraclepdemos.com/fscmUI/faces/FuseWelcome?fndThemeName=Vision_Newsfeed", "may.gee"),
